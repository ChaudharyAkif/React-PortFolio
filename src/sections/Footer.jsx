...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden bg-black">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(50%_55%_at_30%_70%,rgba(161,6,244,0.30),transparent_70%)]" />
      ...
      >
        ...
        <div className="h-[3px] w-24 md:w-32 rounded-full bg-gradient-to-r from-[#0D58CC] via-[#a106f4] to-emerald-400" />
        ...
        <p className="text-xs text-gray-400">
          © {new Date().getFullYear()} Muhammad Akif. All rights reserved.
        </p>
      </motion.div>
    </footer>
  );
