...
const experiences = [
  {
    role: "Full Stack MERN Developer & YouTube Content Creator",
    duration: "2025 – Present",
    description:
      "MERN stack full-stack developer, building complete web applications independently and creating educational coding content on YouTube (AHTCoders).",
  },
  
  {
    role: "Web Developer Intern",
    company: "Adziyo Company",
    duration: "5 months",
    description:
      "In this internship , I gained valuable hands on experience and Worked on full-stack web applications using MongoDB, Express, React, Node.js,and collaborating on deployment and optimization.",
  },
{
    role: "Mern stack ",
    company: "Freelancing",
    duration: "currently",
    description:
      "Building full-stack web applications using MongoDB, Express, React, and Node.js, focusing on responsive design and modern web solutions.",
  },
